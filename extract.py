...
# python extract.py --gpu 0 --S 800 --L 2 --proto deploy_resnet101_normpython.prototxt --weights model.caffemodel --dataset datasets/street2shop --eval_binary datasets/evaluation/compute_ap --temp_dir tmp --dataset_name street2shop --multires --aqe 1 --dbe 20
